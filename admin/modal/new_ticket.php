                ...
                <form class="form-horizontal form-label-left input_mask" method="post" id="add" name="add" enctype='multipart/form-data'>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                            <input type="text" name="agenciauser" class="form-control"  value="<?php echo $nomagen; ?>" readonly>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                            <select class="form-control" name="agenciadestino_id" id="agenciadestino_id">
                                <option selected="" value="">-- Selecciona --</option>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                            <textarea name="description" class="form-control" maxlength="100" placeholder="Descripción"></textarea>
                        </div>
                    </div>
                    <!-- <div class="form-group">
                    ...
                    <!-- JAVASCRIP -->
                    <!-- Condicional para poner recomendaciones -->
                    ...
                    <div class="form-group">
                        <div class="col-md-9 col-sm-9 col-xs-12 col-md-offset-3">
                            <button id="save_data" type="submit" class="btn btn-success">Guardar Ticket</button>
                        </div>
                    </div>
                </form>
