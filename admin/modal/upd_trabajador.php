        ...
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel"><i class="fa fa-plus-pencil"></i> Editar trabajador</h4>
                </div>
                    ...
                    <form class="form-horizontal form-label-left input_mask" method="post" id="upd" name="upd">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9 col-sm-9 col-xs-12">
                              <input name="mod_name" id="mod_name" class="form-control col-md-7 col-xs-12" required type="text" maxlength="20" placeholder="Nombre del trabajador">
                            </div>
                        </div>
