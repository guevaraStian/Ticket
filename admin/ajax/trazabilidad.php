    ...
    if($action == 'ajax'){
        ...
        if ($numrows>0){
            ...
            <table class="table table-striped jambo_table bulk_action">
                ...
                ?>
                    <input type="hidden" value="<?php echo $traza_id;?>" id="traza_id<?php echo $traza_id;?>">
                    <input type="hidden" value="<?php echo $ticket_id;?>" id="ticket_id<?php echo $traza_id;?>">
                    <input type="hidden" value="<?php echo $descriptraza;?>" id="descriptraza<?php echo $traza_id;?>">
                    <input type="hidden" value="<?php echo $cedula;?>" id="user_id<?php echo $traza_id;?>">
                    <input type="hidden" value="<?php echo $created_at;?>" id="created_at<?php echo $traza_id;?>">
                    ...
                    <tr class="even pointer">
                        ...
                        <a href="#" class='btn btn-default' title='Editar Trazabilidad' onclick="obtener_datos_traza('<?php echo $traza_id;?>');" data-toggle="modal" data-target=".bs-example-modal-lg-udptraza"><i class="glyphicon glyphicon-edit"></i></a> 
                        <a href="#" class='btn btn-default' title='Borrar Trazabilidad' onclick="eliminar('<?php echo $traza_id; ?>')"><i class="glyphicon glyphicon-trash"></i> </a></span></td>
                    </tr>
                <?php
                    } //en while
                ?>
