<?php
    ...
    // Si no tiene session se devuelve a index.php donde esta el inicio de sesion
                ...
                <div class="col-md-3 left_col">
                    <div class="left_col scroll-view">
                        <div class="navbar nav_title" style="border: 0;">
                          <a href="iniciousuario.php" class="site_title"><i class="fa fa-ticket"></i> <span>Ticket Coopserp</span></a>
                        </div>
