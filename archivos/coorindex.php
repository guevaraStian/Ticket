	...
	<div class="container">
		...
		<form method="post" id="updti" name="updti" enctype='multipart/form-data'>
			...
			<div class="form-group row">
				...
				<div class="col-md-6  col-sm-6  col-xs-6 ">
					<select class="form-control" name="agenciadestino_id" required id="mod_agenciadestino_id" readonly>
			...
			<div class="form-group row">
				...
				<select class="form-control" name="title" id="mod_title2" readonly>
					...
					<!-- <input type="text" name="title" class="form-control" maxlength="40" placeholder="Titulo" id="mod_title2" value="<?php echo $row7['1']; ?> " readonly></option> -->
				</div>
			</div>
			<div class="form-group row">
				...
				<div class="col-md-6  col-sm-6  col-xs-6 ">
					<textarea name="description" id="mod_description2" maxlength="100" class="form-control col-md-7 col-xs-12" readonly><?php echo $row['2']; ?></textarea>
				</div>
			</div>
			...
			<!-- <div class="form-group row">
				...
				<div class="col-md-6  col-sm-6  col-xs-6 ">
					<select class="form-control" name="trabajador_id" required id="mod_trabajador_id2" readonly>
			...
			<div class="form-group row">
				...
				<div class="col-md-6  col-sm-6 col-xs-6 ">
					<select class="form-control" name="status_id" required id="mod_status_id2" readonly>
						<option selected value="<?php echo $row5['0']; ?>"><?php echo $row5['1']; ?></option>
						...
						?>
								...
								<tr>
									...
									<td><a target="_blank" title='Ver documento' href="upload/<?php echo $fila[1]; ?>" class="btn btn-secondary"><i class="fa fa-download"></i>Ver documento</a>
										<a class="btn btn-danger" title='Borrar Documento' href="../archivos/coorborrar.php?id=<?php echo  $fila[0]; ?>&idti=<?php echo  $idti; ?> "><i class="glyphicon glyphicon-trash"></i> Borrar </a>
										<!--  -->
									</td>
					...
					<tbody>
						...
						?>
								...
								<tr>
									...
									<td><a class="btn btn-danger" title='Borrar Documento' href="../archivos/coorborrartraza.php?id=<?php echo  $filatra[0]; ?>&idti=<?php echo  $idti; ?> "><i class="glyphicon glyphicon-trash"></i> Borrar </a>
										<!--  -->
									</td>
...
<script>
	...
	$("#updti").submit(function(event) {
		...
		$.ajax({
			type: "POST",
			url: "../trabajador/action/updticket.php",
			data: parametros,
