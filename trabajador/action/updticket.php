<?php
	...
	if (empty($_POST['mod_id'])) {
		...
		$sql = "update ticket set title=\"$title\",agenciaarea_id=\"$agenciaarea_id\",trabajador_id=\"$iduser\" ,    priority_id=\"$priority_id\",description=\"$description\",status_id=\"$status_id\",pedido_id=\"$pedido_id\",updated_at=NOW() where id=$id";
