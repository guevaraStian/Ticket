...
$categories = mysqli_query($con, "select * from trabajador");
$titulo = mysqli_query($con, "select * from tituloticket");
?>
<!-- Este codigo de CSS hace que en los select con readonly no se pueda escoger -->
<style type="text/css">
    select[readonly] {
        pointer-events: none;
    }
                ...
                <form class="form-horizontal form-label-left input_mask" method="post" id="upd" name="upd">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                            <select class="form-control" name="pedido_id" required id="mod_pedido_id" readonly>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="title" id="mod_title" readonly>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                            <select class="form-control" name="agenciaarea_id" required id="mod_agenciaarea_id" readonly>
                                <option selected="" value="">-- Selecciona --</option>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                            <select class="form-control" name="trabajador_id" required id="mod_trabajador_id" readonly>
                                <option selected="" value="">-- Selecciona --</option>
